    ...
    <>
      ...
      <section className="bg-[#050505] text-[#FDFCF0] pt-40 pb-32 px-6 md:px-16 overflow-hidden">
        <div className="max-w-6xl mx-auto relative flex flex-col md:flex-row gap-20 items-end">
          <div className="md:w-1/2 relative z-20 w-full ml-0 md:-ml-12">
            <h1 className="text-[80px] md:text-[120px] font-black uppercase tracking-tighter leading-[0.85] mb-6 whitespace-nowrap md:whitespace-normal bg-gradient-to-br from-white to-emerald-300 bg-clip-text text-transparent">
              THE<br />CHEF'S<br />
              <span className="text-emerald-500/30 hidden md:inline">STANDARD.</span>
            </h1>
          ...
          <div className="md:w-1/2 absolute md:relative top-0 right-[-10%] md:right-0 opacity-20 md:opacity-100 z-10 w-full h-full md:h-auto pointer-events-none md:pointer-events-auto">
             <div className="aspect-[3/4] md:aspect-square bg-[#111111] md:w-full relative shadow-[0_0_50px_rgba(16,185,129,0.15)] overflow-hidden group">
               <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1581299894007-aaa50297cf16?q=80&w=1000')] bg-cover bg-center opacity-90 group-hover:scale-105 transition-transform duration-[2s] ease-out" />
               <div className="absolute inset-0 bg-emerald-500 mix-blend-overlay opacity-10" />
      ...
      <section className="bg-white text-[#050505] py-32 px-6 md:px-16">
        <div className="max-w-4xl mx-auto space-y-32">
          ...
          <div className="bg-emerald-50 p-12 md:p-20 border border-emerald-200 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2 group-hover:bg-emerald-500/20 transition-colors duration-[2s]" />
             <h3 className="text-4xl font-black uppercase mb-6 relative z-10 text-emerald-950">Custom Branding Identity</h3>
             <p className="text-xl text-emerald-900/70 leading-relaxed mb-10 relative z-10 max-w-2xl">
             ...
             <Link href="/quote" className="relative z-10 inline-flex items-center space-x-4 pb-2 border-b-2 border-emerald-600 text-emerald-700 hover:text-emerald-500 hover:border-emerald-500 transition-opacity font-bold uppercase tracking-widest text-sm w-max">
